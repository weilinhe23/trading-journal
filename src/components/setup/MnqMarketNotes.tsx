              ...
              <div className="space-y-0.5">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onChange({ plannedRiskPts: e.target.value })
                    }
                    className="border-input bg-background text-foreground w-20 rounded border px-2 py-1 text-xs focus:ring-1 focus:ring-orange-900/60 focus:outline-none"
                  />
                </div>
              </div>
  ...
  return (
    <div className="border-border/40 space-y-4 border-t pt-2">
      ...
      <div className="space-y-4">
        {SEGMENTS.map(
          ({ key, label, time, notePlaceholder, oppPlaceholder }) => {
